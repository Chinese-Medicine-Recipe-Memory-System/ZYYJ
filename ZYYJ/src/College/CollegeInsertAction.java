...
public class CollegeInsertAction extends HttpServlet 
{
			...
			throws ServletException, IOException 
	{
		...
		college.setCollegid(MyTools.toChinese(request.getParameter("id")));
		college.setCollegename(MyTools.toChinese(request.getParameter("name")));
		college.setCollegedetail(MyTools.toChinese(request.getParameter("note")));
