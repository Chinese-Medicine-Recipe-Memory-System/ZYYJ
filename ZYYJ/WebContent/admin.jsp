...
%>
<body onload="loadExternalPage('<%=externalpage==null?"info/userInfo.html" : externalpage%>')">
       ...
       <div class="row">
            <div class="col-md-2 sidebar">
                <ul class="nav sidebar-nav">
                    ...
                    <li class="nav-item">
                    	<a class="nav-text" data-toggle="collapse" href="#institute" aria-expanded="true" aria-controls="institute">
          				...
          				<div class="collapse" id="institute">
          					<ul class="nav sidebar-nav">
          						<li class="nav-item">
          							<a href="#" class="nav-text" onclick="loadExternalPage('institude/manageCollege.html')">
          							<span class="glyphicon glyphicon-education">  学院管理</span></a>
          						</li>
                    			<li class="nav-item">
                    				<a href="#" class="nav-text" onclick="loadExternalPage('institude/manageDepartment.html')">
                    ...
                    <li class="nav-item">
                    	<a class="nav-text" data-toggle="collapse" href="#student" aria-expanded="true" aria-controls="practice">
          				...
          				<div class="collapse" id="student">
          					<ul class="nav sidebar-nav">
          						<li class="nav-item">
          							<a href="#" class="nav-text" onclick="loadExternalPage('student/manageMajor.html')">
                   				 	<span class="glyphicon glyphicon-briefcase">  专业管理</span></a>
                   				</li>
                   				<li class="nav-item">
          							<a href="#" class="nav-text" onclick="loadExternalPage('student/manageGrade.html')">
                   				 	<span class="glyphicon glyphicon-education">  年级管理</span></a>
                   				</li>
                   				<li class="nav-item">
          							<a href="#" class="nav-text" onclick="loadExternalPage('student/manageClass.html')">
                   				 	<span class="glyphicon glyphicon-blackboard">  班级管理</span></a>
                   				</li>
                   				<li class="nav-item">
          							<a href="#" class="nav-text" onclick="loadExternalPage('student/manageStudent.html')">
                    ...
                    <hr class="sidebar-divider">
                    <li class="nav-item">
                    	<a href="#" class="nav-text" onclick="loadExternalPage('info/manageUser.html')">
                    	<span class="glyphicon glyphicon-user">  用户管理</span></a>
                    </li>
                    <hr class="sidebar-divider">
                    ...
                    <hr class="sidebar-divider">
                    <li class="nav-item"><a href="login.html" class="nav-text">注销</a></li>
                </ul>
            </div>
