...
<div class="col-md-10 col-md-offset-1">
	...
	<div class="row">
		...
		<thead>
			<tr><th>考试编号</th><th>考试方案名</th><th>创建者</th><th>总题目数</th><th>总分</th><th>通过分数</th><th>各种难度题目数</th><th>答题时长（分钟）</th><th>创建日期</th><th>科目</th></tr>
		</thead>
		<tbody id="table-tbody">
			...
			for(ExamProgramme e : list){%>
				...
				<td><%=e.getPass_score() %></td><td><%=e.getQuestion_num() %></td><td><%=e.getLimit_time() %></td><td><%=e.getCreatedate() %></td><td><%=e.getCourse() %></td>
				<td><a href="#" data-toggle="modal" data-target="#modify-modal" onclick="javascript:updateModalExamProgramme('<%=e.getExam_id()%>')"><span class="glyphicon glyphicon-pencil"> 修改</span></a></td>
