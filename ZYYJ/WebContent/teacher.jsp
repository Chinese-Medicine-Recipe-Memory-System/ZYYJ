...
<body onload="loadExternalPage('info/userInfo.html')">
                    ...
                    <li class="nav-item">
                    	<a class="nav-text" data-toggle="collapse" href="#study" aria-expanded="true" aria-controls="study">
          				...
          				<div class="collapse" id="study">
          					<ul class="nav sidebar-nav">
          						<li class="nav-item">
          							<a href="#" class="nav-text" onclick="loadExternalPage('study/manageCourse.html')">
          							<span class="glyphicon glyphicon-book">  科目管理</span></a>
          						</li>
                    			<li class="nav-item">
                    				<a href="#" class="nav-text" onclick="loadExternalPage('study/manageChapter.html')">
                    				<span class="glyphicon glyphicon-bookmark">  章节管理</span></a>
                    			</li>
                    			<li class="nav-item">
                    				<a href="#" class="nav-text" onclick="loadExternalPage('study/manageKnowledgepoint.html')">
                    				<span class="glyphicon glyphicon-apple">  知识点管理</span></a>
                    			</li>
                    			<li class="nav-item">
                    				<a href="#" class="nav-text" onclick="loadExternalPage('study/manageQuestion.html')">
                    				<span class="glyphicon glyphicon-pencil">  题目管理</span></a>
                    			</li>
          					</ul>
          				</div>
                    </li>
                    ...
                    <li class="nav-item">
                    	<a class="nav-text" data-toggle="collapse" href="#practice" aria-expanded="true" aria-controls="practice">
          				...
          				<div class="collapse" id="practice">
          					<ul class="nav sidebar-nav">
          						<li class="nav-item">
          							<a href="#" class="nav-text" onclick="loadExternalPage('practice/manageProgramme.html')">
                    				<span class="glyphicon glyphicon-list-alt">  练习方案管理</span></a>
                    			</li>
                    
                    			<li class="nav-item">
                    				<a href="#" class="nav-text" onclick="loadExternalPage('practice/manageCheckpoint.html')">
                    ...
                    <li class="nav-item">
                    	<a class="nav-text" data-toggle="collapse" href="#credit" aria-expanded="true" aria-controls="credit">
          				...
          				<div class="collapse" id="credit">
          					<ul class="nav sidebar-nav">
          						<li class="nav-item">
          							<a href="#" class="nav-text" onclick="loadExternalPage('credit/studentScore.html')">
                     ...
                     <hr class="sidebar-divider">
                    <li class="nav-item">
                    	<a class="nav-text" data-toggle="collapse" href="#grade" aria-expanded="true" aria-controls="grade">
            				<span class="glyphicon glyphicon-th-list">  成绩查看</span>
            				<span class="glyphicon glyphicon-chevron-down menu-arrow"></span>
          				</a>
          				<div class="collapse" id="grade">
          					<ul class="nav sidebar-nav">
          						<li class="nav-item">
          							<a href="#" class="nav-text" onclick="loadExternalPage('grade/manageGrade.html')">
                    				<span class="glyphicon glyphicon-ok-circle">  成绩管理</span></a>
                    			</li>
          						<li class="nav-item">
          							<a href="#" class="nav-text" onclick="loadExternalPage('practice/studentPractice.html')">
                    				<span class="glyphicon glyphicon-ok-circle">  闯关情况</span></a>
                    			</li>
          					</ul>
          				</div>
                    </li>
                    <hr class="sidebar-divider">
                    <li class="nav-item"><a href="#" class="nav-text" onclick="loadExternalPage('info/userInfo.html')">
                    <span class="glyphicon glyphicon-home">  个人中心</span></a></li>
                    <hr class="sidebar-divider">
                    <li class="nav-item"><a href="login.html" style="color:white">注销</a></li>
                </ul>
            </div>
